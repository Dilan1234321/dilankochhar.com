...
export const craftPillars: CraftPillar[] = [
  {
    ...
    body: `Dilly isn't a landing page with a waitlist — it's a multi-vertical OS with auth, metering, voice, and three product skins. Client sites aren't brochures either: Erickson and Sigma exist to generate quotes; N+1 and Engineers in AI exist to generate hiring conversations. If it doesn't change what someone does next, I haven't finished.`,
    where: ["Dilly", "Engineers in AI", "N+1 Talent", "Erickson Flooring"],
  },
  {
    slug: "ai-agents",
    title: "AI that does a job",
    lead: "I build agents with receipts — cron logs, drafts, scores — not chat demos.",
    body: `On Dilly, models audit resumes, match jobs with embeddings, coach interviews, and extract memory under anti-hallucination rules. On Engineers in AI, a weekday cron reads live ATS boards and drafts outbound with Groq. On N+1, a Python prospector scores hiring urgency and writes cold email. The skill isn't "I called an API." It's wiring models into a loop that survives Monday morning.`,
    where: ["Dilly", "Engineers in AI", "N+1 Talent"],
  },
  {
    slug: "full-stack",
    ...
    where: ["Dilly", "Sigma Marble Studio", "Engineers in AI", "Atlas Portfolio"],
  },
  {
    slug: "growth",
    title: "Growth & discovery",
    lead: "A beautiful site that nobody finds is a hobby.",
    body: `Programmatic SEO on N+1 (fifty-plus state and role pages from Python generators). Schema, sitemaps, llms.txt for AI search. Dedicated SEO landings on Engineers in AI. Quote funnels and FormSubmit/Web3Forms/Formspree on every client site that needs leads. I treat discoverability and conversion as engineering, not afterthoughts.`,
    where: ["N+1 Talent", "Engineers in AI", "Erickson Flooring", "UTampa AKPSI"],
  },
  {
    slug: "design",
